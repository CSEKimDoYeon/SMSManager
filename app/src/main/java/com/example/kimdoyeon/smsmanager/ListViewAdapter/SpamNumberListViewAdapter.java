...
public class SpamNumberListViewAdapter extends ArrayAdapter{
    ...
    public SpamNumberListViewAdapter(@NonNull Context context, int resource, ArrayList<String> arr)  {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listview_item_spam_number, parent, false);
        }

        /*------------------------UI선언 및 기능 정의----------------------------*/
        TextView titleTextView = (TextView) convertView.findViewById(R.id.textView1) ;

        CircleButton btn_delete = (CircleButton) convertView.findViewById(R.id.btn_spam_num_delete);
        btn_delete.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDbOpenHelper = new SpamNumberDbOpenHelper(context);
                mDbOpenHelper.open();
